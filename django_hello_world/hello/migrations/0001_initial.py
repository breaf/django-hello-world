...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RequestRecord'
        db.create_table('hello_requestrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('hello', ['RequestRecord'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RequestRecord'
        db.delete_table('hello_requestrecord')
