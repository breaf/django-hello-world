...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hello_logrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('changes_type', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('added_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('hello', ['LogRecord'])


    def backwards(self, orm):
        # Deleting model 'LogRecord'
        db.delete_table('hello_logrecord')
    ...
    models = {
        ...
        'hello.requestrecord': {
            'Meta': {'object_name': 'RequestRecord'},
            'added_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
