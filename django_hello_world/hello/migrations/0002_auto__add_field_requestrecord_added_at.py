...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestRecord.added_at'
        db.add_column('hello_requestrecord', 'added_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequestRecord.added_at'
        db.delete_column('hello_requestrecord', 'added_at')
