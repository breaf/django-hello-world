...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestRecord.priority'
        db.add_column('hello_requestrecord', 'priority',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequestRecord.priority'
        db.delete_column('hello_requestrecord', 'priority')
    ...
    models = {
        ...
        'hello.logrecord': {
            ...
            'changes_type': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        'hello.requestrecord': {
            'Meta': {'ordering': "('added_at', '-priority')", 'object_name': 'RequestRecord'},
            'added_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
